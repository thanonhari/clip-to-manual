...
|---|---|---|
| **Meta-Prompting** | การใช้ AI ตัวหนึ่งมาเขียนหรือปรับแต่ง Prompt ให้กับ AI อีกตัวหนึ่ง | เมื่อผู้ใช้พิมพ์สั้นๆ ว่า *"อยากได้คู่มือ"* AI ตัวหน้าจะแปลงเป็น *"จงเขียนคู่มือระดับมืออาชีพ แบ่งหัวข้อ 1-2-3 พร้อมตารางคีย์ลัด"* ก่อนส่งให้โมเดลใหญ่ประมวลผล |
| **Ambiguity Score Check** | การตรวจสอบระดับความคลุมเครือของคำสั่ง | AI เช็คว่าคำสั่งขาดอะไร เช่น ขาดกลุ่มเป้าหมาย (ผู้เริ่มต้น/มือโปร), ขาดภาษาที่ต้องการ, หรือขาดความยาว |
| **Context Enrichment** | การนำข้อมูลแวดล้อมรอบตัวมาเติมเต็มคำสั่ง | ดึงสเปกเครื่อง (CPU i5), ดึงโทเคน Telegram, ดึงคีย์บอร์ดชอร์ตคัต มาแนบใน Prompt อัตโนมัติโดยที่ผู้ใช้ไม่ต้องพิมพ์บอกทุกครั้ง |
| **Structured Translation** | การแปลงภาษาพูดทั่วไปให้กลายเป็นคำสั่งเชิงระบบ | แปลงข้อความคุยเล่นของมนุษย์ (Natural Language) ให้กลายเป็นรูปแบบ JSON หรือ Step-by-Step Prompt ที่ AI คำนวณได้แม่นยำ |
| **Zero-Shot vs Few-Shot Prompting** | การสั่งงานแบบไม่ให้ตัวอย่าง (Zero) เทียบกับให้ตัวอย่าง 2-3 อันก่อนทำ (Few) | Zero-shot: *"แปลคลิปนี้เป็นคู่มือ"* <br>Few-shot: *"นี่คือตัวอย่างคู่มือบทที่ 1 จงทำบทที่ 2 เลียนแบบโครงสร้างนี้"* |
| **Chain-of-Thought (CoT)** | การให้ AI คิดทีละขั้นตอนก่อนตอบ | AI จะวิเคราะห์เนื้อหาคลิป -> แยกฟังก์ชันสำคัญ -> เรียงลำดับขั้นตอน -> แล้วค่อยเขียนบทสรุป |
| **Deterministic Fallback** | แผนสำรองแบบแม่นยำ ไม่พึ่งพาอินเทอร์เน็ต | เมื่อ Gemini AI ใช้ไม่ได้หรือเน็ตหลุด ระบบมีโค้ดคำนวณในเครื่องตัวเองเพื่อสกัดหัวข้อให้ผู้ใช้ได้ทันทีโดยไม่พัง |
